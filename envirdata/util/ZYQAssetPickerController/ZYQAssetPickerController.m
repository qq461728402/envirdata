...
- (void)setupButtons
{
    ...
    [but addTarget:self action:@selector(finishPickingAssets:) forControlEvents:UIControlEventTouchUpInside];
...
- (BOOL)shouldSelectAsset:(ALAsset *)asset
{
    ...
    return (selectable && _indexPathsForSelectedItems.count < 4);
}
...
- (void)setTitleWithSelectedIndexPaths:(NSArray *)indexPaths
{
    ...
    NSLog(@"self.number is %d",(int)self.number);
}
#pragma mark - Actions
