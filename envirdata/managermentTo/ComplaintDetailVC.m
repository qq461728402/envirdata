...
@interface ComplaintDetailVC ()<PictureViewDelegate>
...
@synthesize complaintTasksModel;
...
- (void)viewDidLoad {
    ...
    titlelb.text=complaintTasksModel.title;
    ...
    titlelb.text=complaintTasksModel.address;
    [tempView addSubview:titlelb];
    ...
    titlelb.textColor=subColor;
    titlelb.text=complaintTasksModel.content;
    titlelb.font=Font(15);
    [tempView addSubview:titlelb];
    ...
    sublb.text=@"图片：";
    [tempView addSubview:sublb];
    NSMutableArray *pricrAry =[NSMutableArray arrayWithArray:[complaintTasksModel.pics componentsSeparatedByString:@","]];
    ...
    titlelb.numberOfLines=2;
    titlelb.textColor=subColor;
    titlelb.text=complaintTasksModel.dname;
    titlelb.font=Font(15);
    [tempView addSubview:titlelb];
    ...
    titlelb.numberOfLines=2;
    titlelb.textColor=subColor;
    titlelb.text=complaintTasksModel.ctime;
    titlelb.font=Font(15);
    [tempView addSubview:titlelb];
    oneline=[[UILabel alloc]initWithFrame:CGRectMake(0, sublb.bottom-0.5, tempView.width, 0.5)];
    [oneline setBackgroundColor:[UIColor colorWithRGB:0xc8c8c8]];
    ...
    if ([complaintTasksModel.status intValue]==1) {//表示我待办
        ...
        titlelb.numberOfLines=0;
        titlelb.textColor=subColor;
        titlelb.text=complaintTasksModel.handle_des;
        titlelb.font=Font(15);
        [tempView addSubview:titlelb];
        ...
        sublb.text=@"描述图片：";
        [tempView addSubview:sublb];
        NSMutableArray *pricrAry1 =[NSMutableArray arrayWithArray:[complaintTasksModel.handle_pics componentsSeparatedByString:@","]];
        ...
        titlelb =[[UILabel alloc]initWithFrame:CGRectMake(sublb.right, 0, SCREEN_WIDTH-sublb.right-SCALE(8), sublb.height)];
        titlelb.numberOfLines=2;
        titlelb.text=complaintTasksModel.hname;
        titlelb.font=Font(15);
        titlelb.textColor=subColor;
        [tempView addSubview:titlelb];
        oneline=[[UILabel alloc]initWithFrame:CGRectMake(0, sublb.bottom-0.5, tempView.width, 0.5)];
        ...
        titlelb.numberOfLines=2;
        titlelb.textColor=subColor;
        titlelb.text=complaintTasksModel.handle_time;
        titlelb.font=Font(15);
        [tempView addSubview:titlelb];
        oneline=[[UILabel alloc]initWithFrame:CGRectMake(0, sublb.bottom-0.5, tempView.width, 0.5)];
        [oneline setBackgroundColor:[UIColor colorWithRGB:0xc8c8c8]];
...
-(void)dealTask{
    ...
    if (picture_view1.pictureAry.count>3) {
...
-(void)handlePatrolTasksWithPics:(NSString*)pics{
    ...
    [self networkPost:API_HANDLECOMPLAINT parameter:@{@"id":complaintTasksModel.id,@"handle_des":hcontent_tv.text,@"handle_pics":pics,@"handler":userId} progresHudText:nil completionBlock:^(id rep) {
